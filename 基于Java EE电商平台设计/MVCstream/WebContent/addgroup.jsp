    ...
    <div  align="center">
            ...
            <div class="user-info" align="center">
                ...
                <div class="am-cf am-padding">
                    <br /><br /><br /><br /><div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">添加游戏</strong> / <small>Add</small></div>
                </div>
                <hr/>
            </div>
            <!--个人信息 -->

            <form action="tianjia.do" method="post" enctype="multipart/form-data">
            ...
            <div class="text-place">        
                    ...
                    游戏类别： <input type="text" name="type" id="type"><br><br><br>
           
                    游戏C类别：<input type="text" name="typec" id="typec"><br><br><br>
            
                    游戏折扣：  <input type="text" name="discount" id="discount"><br><br><br>                
           
                    发行商：     <input type="text" name="faxing" id="faxing"><br><br><br> 
