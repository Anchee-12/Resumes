    ...
    <div  align="center">
            ...
            <div class="user-info" align="center">
                ...
                <div class="am-cf am-padding">
                    <br /><br /><br /><br /><br /><br /><br /><br /><br /><div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">管理员操作成功</strong> / <small>Success</small></div>
                </div>
                <hr/>
            </div>
            <!--个人信息 -->
            ...
            <%String message=(String)request.getAttribute("message");
               shangpin good=(shangpin)request.getAttribute("goodInfo");
             %>
