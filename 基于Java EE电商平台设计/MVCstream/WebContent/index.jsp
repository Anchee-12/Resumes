          ...
          <ul>
            ...
            <li><a href="data-visualization.html" ><i class="fa fa-database fa-fw"></i>游戏</a>
                  <ul class="sub_menu" >
                  	...
                  	<h4><li><a href="List1.jsp">休闲</a></li></h4> 
            ...
            <li><a href="login.jsp"><i class="fa fa-eject fa-fw"></i>购物车</a></li>
          </ul>  
        </nav>
      </div>
      <!-- Main content --> 
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                ...
                <li><a href="SteamLogin.jsp" class="active">登录</a></li>
              </ul>  
            </nav> 
          </div>
        </div>
        ...
        <a href="javascript:;"></a>
          ...
          <div class="templatemo-flex-row flex-content-row">
            <div class="templatemo-content-widget white-bg col-2">
              <div class="square"></div>
              <h2 class="templatemo-inline-block">Stream</h2><hr>
              <p>Our website bases on Steam Platform</p>
              <p>But we do better than Steam!</p>              
            </div>
            <div class="templatemo-content-widget white-bg col-1 text-center">
     
              <h2 class="text-uppercase">DOTA2</h2>
              <h3 class="text-uppercase margin-bottom-10">多人    策略   合作</h3>
              <img src="images/DOTA.jpg" alt="Bicycle" class="img-circle img-thumbnail">
            </div>
              <div class="templatemo-content-widget white-bg col-1 text-center">
