...
<%Goods  good=(Goods)request.getAttribute("goodInfo"); %>  
 <!-- Left column -->
    ...
    <div  align="center">
            ...
            <div class="user-info" align="center">
                ...
                <div class="am-cf am-padding">
                    <br /><br /><br /><br /><div class="am-fl am-cf"><h2><strong class="am-text-danger am-text-lg">查询游戏成功</strong></h2><br><em>Success!</em></div>
                </div>
                <hr/>
            </div>
            <!--个人信息 -->
          ...
          <table cellpadding="1"align="center" cellspacing="1" height="100" width="1000" border="1">
            <tr>
          <th>游戏图片</th>
          <th>游戏名</th>
          <th>开发商</th>
       ...
       <tr>
          <%String path=request.getContextPath()+File.separator +"goodsupload"+File.separator+good.getPhoto();%>
          <td><img src="<%=path %>"/></td>
          <td><%=good.getName() %></td>
          <td><%=good.getKaifashang() %></td>
          <td><%=good.getDescribe1() %></td>
          <td><%=good.getType() %></td>
          <td><%=good.getFaxingshang() %></td>
          <td><%=good.getDiscount() %></td>
          <td><%=good.getPrice() %></td>
      </tr>
          </table>
                
                <div class="info-btn" align="middle">
                    <div class="am-btn am-btn-danger">
                      ...
                      <a href="selectgroup.jsp">继续查询</a><br><br>  
                      <a href="operation.jsp">退出查询</a><br><br>	
                  </div>
                </div>
