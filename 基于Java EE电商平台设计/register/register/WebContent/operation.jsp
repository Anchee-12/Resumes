    ...
    <div  align="center">
            ...
            <div class="user-info" align="center">
                ...
                <div class="am-cf am-padding">
                    <br /><br /><br /><br /><br /><br /><br /><br /><br /><div class="am-fl am-cf"><h2><strong class="am-text-danger am-text-lg" >管理员操作</strong></h2><br><em>Operation</em></div>
                </div>
                <hr/>
            </div>
            <!--个人信息 -->
            ...
            <a href="selectgroup.jsp">查询商品</a><br><br>
            <a href="deleteuser.jsp">删除用户</a><br><br>
