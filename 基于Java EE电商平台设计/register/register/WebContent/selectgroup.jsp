    ...
    <div  align="center">
            ...
            <div class="user-info" align="center">
                ...
                <div class="am-cf am-padding">
                    <br /><br /><br /><br /><div class="am-fl am-cf"><h2><strong class="am-text-danger am-text-lg">查询游戏</strong></h2><br><em>SelectGame</em></div>
                </div>
                <hr/>
            </div>
            <!--个人信息 -->

            <form action="selectgroup.do" method="post" >
                
            <div class="text-place">        
                    游戏名：    <input type="text" name="goodsName" ></div><br><br>
        
                   
                <div class="info-btn" align="middle">
                    <div class="am-btn am-btn-danger">
                    
                    	<input type="submit" value="查询游戏"></div><br />  	<br /> 
                    	<br />  	
                    	<div align="middle">
                  	<a href="index.jsp">退出查询</a><br><br>
