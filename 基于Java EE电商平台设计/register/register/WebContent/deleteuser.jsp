    ...
    <div  align="center">
            ...
            <div class="user-info" align="center">
                ...
                <div class="am-cf am-padding">
                    <br /><br /><br /><br /><div class="am-fl am-cf"><h2><strong class="am-text-danger am-text-lg">删除用户</strong></h2><br><em>DeleteUser</em></div>
                </div>
                <hr/>
            </div>
            <!--个人信息 -->
            ...
            <div class="text-place">        
                    用户名：    <input type="text" name="userName" ></div><br><br>
                    用户ID:   <input type="text" name="id" ></div><br><br>
                   
                   
                <div class="info-btn" align="middle">
                    <div class="am-btn am-btn-danger">
                    
                    	<input type="submit" value="拉黑用户"></div><br />  	<br /> 
                    	<br />  	
                    	<div align="middle">
                  	<a href="index.jsp">退出删除</a><br><br>
