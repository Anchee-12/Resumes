  ...
  <script LANGUAGE="JavaScript">
    function show(){
     ...
     <br />
               ...
               <div>
              <h1 class="text-uppercase p1">编辑个人中心</h1>
              	</div>
     <br />
     <br />
     <br />
     <div class="templatemo-top-nav-container">
      ...
      <form action="editor.do" method="post" enctype="multipart/form-data">     
     <h3> <div style="float: left;">头像:</div> </h3>
           <img src="images/1.png" alt=" " > <hr>
           <input type ="file" name="photo"><br />
           <h3>  <div style="float: left;"> 用户名：&nbsp;&nbsp;&nbsp;<input type ="text" name="userName"></div><br/><br/></h3><hr>
       <h3><div style="float: left;">性别：&nbsp;&nbsp;&nbsp;&nbsp;<input type ="text" name="gender"></div><br/><br/></h3><hr>
       <h3> <div style="float: left;">年龄：&nbsp;&nbsp;&nbsp;&nbsp;<input type ="text" name="age"></div><br/><br/></h3><hr>
       <h3> <div style="float: left;"> 邮箱：&nbsp;&nbsp;&nbsp;&nbsp;<input type ="text" name="email"></div><br/><br/>  </h3><hr>
       <h3> <div style="float: left;"> 地区：&nbsp;&nbsp;&nbsp;&nbsp;<input type ="text" name="region"></div><br/><br/>  </h3><hr>
        <div class="edit">
  <br/> <h3> <input type="submit" value="编辑"></h3><br/>
</div>
