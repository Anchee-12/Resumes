    ...
    <div  align="center">
            ...
            <div class="user-info" align="center">
                ...
                <div class="am-cf am-padding">
                    <br /><br /><br /><br /><br /><br /><br /><br /><br /><div class="am-fl am-cf"><h2><strong class="am-text-danger am-text-lg">管理员操作成功</strong></h2><br><em>Success!</em></div>
                </div>
                <hr/>
            </div>
            <!--个人信息 -->
            ...
            <%String message=(String)request.getAttribute("message");
             ...
             <br>
			 <a href="addgroup.jsp">继续添加商品</a><br><br>
 		     <a href="deletegroup.jsp">继续删除商品</a><br><br>
			 <a href="updategroup.jsp">继续修改商品</a><br><br>
			 <a href="selectgroup.jsp">继续查询商品</a><br><br>
			 <a href="deleteuser.jsp">继续删除用户</a><br><br>
