    ...
    <div  align="center">
            ...
            <div class="user-info" align="center">
                ...
                <div class="am-cf am-padding">
                    <br /><br /><br /><br /><div class="am-fl am-cf"><h2><strong class="am-text-danger am-text-lg">删除游戏</strong></h2><br><em>DeleteGame</em></div>
                </div>
                <hr/>
            </div>
            <!--个人信息 -->
            ...
            <div class="text-place">        
                ...
                <div class="info-btn" align="middle">
                    <div class="am-btn am-btn-danger">
                    	...
                    	<input type="submit" value="删除游戏"></div><br />  	<br /> 
                    	<br />  	
                    	<div align="middle">
